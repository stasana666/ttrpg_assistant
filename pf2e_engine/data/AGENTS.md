...
## Key Files
- `schemas/*.ttrpg`: source definitions for generated inventory/condition C++ types.
...
## Conventions
- JSON field names are snake_case, generated from `.ttrpg` PascalCase field names by the codegen conventions.
